                    ...
                    <TableRow key={course.id}>
                      ...
                      <TableCell>
                        <Badge
                          ...
                          className={
                            course.isPublished
                              ? "bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-400 border-green-200 dark:border-green-700 text-xs"
                              : "bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-500 border-gray-200 dark:border-gray-700 text-xs"
                          }
                        >
                          {course.isPublished
