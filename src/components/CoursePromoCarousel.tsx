...
const promoCourses: PromoCourse[] = [
  // === ОСНОВНЫЕ КУРСЫ (локальные изображения) ===
  { id: 1, title: "Системное администрирование в Linux", description: "Освойте администрирование Linux-серверов: от установки и настройки до автоматизации и мониторинга.", image: "/courses/sysadmin.jpg", url: "https://stepik.org/a/207061", tag: "DevOps", tagColor: "bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300", level: "Начинающий", levelColor: "bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300", duration: "8 недель", rating: 4.8, isNew: true },
