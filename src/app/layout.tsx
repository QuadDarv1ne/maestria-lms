...
const geistMono = localFont({
  src: [
    { path: "./fonts/GeistMono-100.ttf", weight: "100" },
    { path: "./fonts/GeistMono-200.ttf", weight: "200" },
    { path: "./fonts/GeistMono-300.ttf", weight: "300" },
    ...
    { path: "./fonts/GeistMono-800.ttf", weight: "800" },
    { path: "./fonts/GeistMono-900.ttf", weight: "900" },
  ],
