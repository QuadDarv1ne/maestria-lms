...
export async function POST() {
  try {
    ...
    const courses = await Promise.all([
      ...
      db.course.create({
        data: {
          ...
          image: "https://iili.io/BpcZGe9.jpg",
          price: 0,
          level: "beginner",
          duration: "8 недель",
          language: "ru",
      ...
      db.course.create({
        data: {
          ...
          image: "https://iili.io/BpcZ1JS.jpg",
          price: 2990,
          oldPrice: 4990,
          level: "intermediate",
          duration: "6 недель",
      ...
      db.course.create({
        data: {
          ...
          image: "https://iili.io/BpcZlg2.jpg",
          price: 1990,
          oldPrice: 3490,
          level: "beginner",
          duration: "10 недель",
      ...
      db.course.create({
        data: {
          ...
          image: "https://iili.io/BpcZ7sf.jpg",
          price: 4990,
          oldPrice: 7990,
          level: "intermediate",
          duration: "12 недель",
      ...
      db.course.create({
        data: {
          ...
          image: "https://iili.io/Bp1MXrQ.jpg",
          price: 1490,
          oldPrice: 2490,
          level: "beginner",
          duration: "6 недель",
      ...
      db.course.create({
        data: {
          ...
          image: "https://iili.io/BpcZnlp.jpg",
          price: 3490,
          level: "advanced",
          duration: "8 недель",
          language: "ru",
      ...
      db.course.create({
        data: {
          ...
          image: "https://iili.io/BpcZfWJ.jpg",
          price: 2490,
          oldPrice: 3990,
          level: "beginner",
          duration: "10 недель",
      ...
      db.course.create({
        data: {
          ...
          image: "https://iili.io/BpcZMbe.jpg",
          price: 2490,
          level: "beginner",
          duration: "8 недель",
          language: "ru",
      ...
      db.course.create({
        data: {
          ...
          image: "https://iili.io/BpcZqiv.jpg",
          price: 3990,
          oldPrice: 5990,
          level: "intermediate",
          duration: "8 недель",
      ...
      db.course.create({
        data: {
          ...
          image: "https://iili.io/BpcZCfR.jpg",
          price: 5990,
          level: "advanced",
          duration: "12 недель",
          language: "ru",
      ...
      db.course.create({
        data: {
          ...
          image: "https://iili.io/BpcZ3Dg.jpg",
          price: 4490,
          oldPrice: 6990,
          level: "intermediate",
          duration: "10 недель",
      ...
      db.course.create({
        data: {
          ...
          image: "https://iili.io/BpcZ5WG.jpg",
          price: 3990,
          level: "intermediate",
          duration: "8 недель",
          language: "ru",
    ...
    return NextResponse.json({
      ...
      credentials: {
        admin: { email: "admin@maestro7it.ru", password: "admin123" },
        teacher: { email: "teacher@maestro7it.ru", password: "teacher123" },
      },
    }, { status: 201 });
  } catch (error) {
