...
const ru = JSON.parse(fs.readFileSync(path.join(__dirname, "src/lib/locales/ru.json"), "utf-8"));
const en = JSON.parse(fs.readFileSync(path.join(__dirname, "src/lib/locales/en.json"), "utf-8"));
const zh = JSON.parse(fs.readFileSync(path.join(__dirname, "src/lib/locales/zh.json"), "utf-8"));
